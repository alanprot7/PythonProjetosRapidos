class Emolumento:
    ...
    def __init__(self, valores, custas, protocolos_tabela):
        self.TAMANHO_ARRAY_CUSTAS = 10
        self.TAMANHO_ARRAY_VALORES = 13 # aumentar a cada nova tabela
        ...
        self.custas = custas
        self.cancelamento = []
        self.protocolo = protocolos_tabela[-1]
        self.protocolos_tabela = protocolos_tabela
    ...
    def decide_valor(self, valor):
        ...
        posicao = self.escolhe_tabelas_por_protocolo(posicao)
    ...
    def escolhe_tabelas_por_protocolo(self, posicao):
        for protocolo_item in self.protocolos_tabela:
            if int(self.protocolo) < int(protocolo_item):
                posicao -= 7
        return posicao
